...
Similarly, we see that 2 does not divide into 5 because 2 times 2 is 4 and 2 times 3 is 6. There are no integers between 2 and 3 and it appears that such figure is precisely the requirement for 5 to be divisible by 2. Let us formalize this intuition.  
